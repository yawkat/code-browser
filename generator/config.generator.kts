...
artifacts {
    ...
    val log4jMeta = ArtifactMetadata(logoUrl = "https://logging.apache.org/log4j/2.x/images/logo.png")
    maven("org.apache.logging.log4j", "log4j-core", "2.11.0", metadata = log4jMeta)
    maven("org.apache.logging.log4j", "log4j-core", "2.12.0", metadata = log4jMeta)
    maven("org.apache.logging.log4j", "log4j-api", "2.12.0", metadata = log4jMeta)
    ...
    maven("com.fasterxml.jackson.core", "jackson-annotations", "2.9.5")
    maven("com.fasterxml.jackson.core", "jackson-core", "2.9.5")
    maven("com.fasterxml.jackson.datatype", "jackson-datatype-jdk8", "2.9.5")
    maven("com.fasterxml.jackson.datatype", "jackson-datatype-jsr310", "2.9.5")
    ...
    maven("org.ow2.asm", "asm", "6.2.1", metadata = asmMeta)
    maven("org.ow2.asm", "asm-tree", "6.2.1", metadata = asmMeta)
    maven("org.ow2.asm", "asm-commons", "6.2.1", metadata = asmMeta)
    maven("org.ow2.asm", "asm", "7.1", metadata = asmMeta)
    maven("org.ow2.asm", "asm-tree", "7.1", metadata = asmMeta)
    maven("org.ow2.asm", "asm-commons", "7.1", metadata = asmMeta)
