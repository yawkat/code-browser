...
artifacts {
    ...
    val eclipseMeta = ArtifactMetadata(logoUrl = "https://www.eclipse.org/artwork/images/v2/logo-800x188.png")
    maven("org.eclipse.jdt", "org.eclipse.jdt.core", "3.20.0", metadata = eclipseMeta)
    maven("org.eclipse.jdt", "org.eclipse.jdt.launching", "3.16.0", metadata = eclipseMeta)
    maven("org.eclipse.jdt", "org.eclipse.jdt.core.manipulation", "1.13.0", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.core.runtime", "3.17.0", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.osgi", "3.15.100", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.equinox.common", "3.10.600", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.equinox.registry", "3.8.600", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.equinox.preferences", "3.7.600", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.equinox.app", "1.4.300", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.core.contenttype", "3.7.500", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.core.jobs", "3.10.600", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.core.resources", "3.13.600", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.ltk.core.refactoring", "3.10.300", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.core.expressions", "3.6.600", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.text", "3.10.0", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.core.filesystem", "1.7.600", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.core.filebuffers", "3.6.800", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.core.commands", "3.9.600", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.core.variables", "3.4.700", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.debug.core", "3.14.100", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.team.core", "3.8.800", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.ant.core", "3.5.600", metadata = eclipseMeta)
    maven("org.eclipse.platform", "org.eclipse.compare.core", "3.6.700", metadata = eclipseMeta)

    val grizzlyMeta = ArtifactMetadata(logoUrl = "https://javaee.github.io/grizzly/images/grizzlyHead.png")
    maven("org.glassfish.grizzly", "grizzly-http-server", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-http-ajp", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-http-server-core", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-http-server-multipart", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-http-servlet", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-http", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-http2", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-framework", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-websockets", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-websockets-server", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-comet", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-core", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-portunif", "2.4.4", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-npn-api", "1.9", metadata = grizzlyMeta)
    maven("org.glassfish.grizzly", "grizzly-npn-bootstrap", "1.9", metadata = grizzlyMeta)

    val glassfishMeta = ArtifactMetadata(logoUrl = "https://upload.wikimedia.org/wikipedia/en/8/85/GlassFish_logo.svg")
    maven("org.glassfish.gmbal", "gmbal", "4.0.1", metadata = glassfishMeta)
    maven("org.glassfish.pfl", "pfl-basic", "4.1.0", metadata = glassfishMeta)
    maven("org.glassfish.pfl", "pfl-tf", "4.1.0", metadata = glassfishMeta)
    maven("org.glassfish.pfl", "pfl-basic-tools", "4.1.0", metadata = glassfishMeta)
    maven("org.glassfish.pfl", "pfl-tf-tools", "4.1.0", metadata = glassfishMeta)
    maven("org.glassfish.pfl", "pfl-asm", "4.1.0", metadata = glassfishMeta)
    maven("org.glassfish.pfl", "pfl-dynamic", "4.1.0", metadata = glassfishMeta)
}